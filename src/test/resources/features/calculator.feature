@calculator
  Feature: Various sites

    @calculator1
      Scenario: Unit conversion
      Given I go to "converter" page
      When "Temperature": 54 "Fahrenheit" to "Celsius" result is 12.2
      And "Weight": 170 "Pound" to "Kilogram" result is 77
      And "Length": 50 "Mile" to "Kilometer" result is 80.4
